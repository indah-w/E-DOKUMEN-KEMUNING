            ...
            <div class="container">				
                <div class="row d-flex align-items-center justify-content-center">
                    <div class="about-content col-lg-12">
                        ...
                        <p class="text-white link-nav"><a href="/beranda">Beranda </a>  <span class="lnr lnr-arrow-right"></span>  <a href="{{url('sites/kontak')}}"> Kontak Kami</a></p>
                    </div>	
                </div>
            </div>
        </section>
                    ...
                    <div class="col-lg-4 d-flex flex-column address-wrap">
                        <div class="single-contact-address d-flex flex-row">
                            ...
                            <div class="contact-details">
                                <h5>Kampung Hijau Kemuning</h5>
                                <p>
                                    Perum Binong Permai Blok BB, Suka Bakti, Kec. Curug, Tangerang, Banten 15810
                                </p>
                            </div>
                        </div>
                        <div class="single-contact-address d-flex flex-row">
