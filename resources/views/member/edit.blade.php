		    ...
		    <div class="card-body">
		    	<form action="{{ route('member.update', $member->id) }}" method="POST">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-7">
                            <input id="no_kk" type="number" class="form-control @error('no_kk') is-invalid @enderror" name="no_kk" value="{{ $member->no_kk }}" required autocomplete="no_kk" autofocus>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-7">
                            <input id="no_ktp" type="number" class="form-control @error('no_ktp') is-invalid @enderror" name="no_ktp" value="{{ $member->no_ktp }}" required autocomplete="no_ktp" autofocus>
