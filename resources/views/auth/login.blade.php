...
<head>
    ...
    <title>Login Register | Kampung Hijau Kemuning</title>
...
<body>
    ...
    <img src="{{asset('/dashboard')}}/img/header.png">
    <div class="login-content">
        <!-- Login -->
        <div class="nk-block toggled" id="l-login">
            <form class="nk-form" action="{{ route('login') }}" method="POST">
              @error('email')
                  {{ $message }}
              @enderror
                @csrf
    ...
    <!-- Login JS
		============================================ -->
    <script src="{{asset('/dashboard')}}/js/login/login-action.js"></script>
    <!-- plugins JS
		============================================ -->
